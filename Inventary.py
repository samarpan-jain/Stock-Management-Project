...
def toplevel2(top):
    ...
    for i in mycursor:
        ...
        l6.place(relx=0.046, rely=0.827, relheight=0.025, relwidth=0.10)
        l7.place(relx=0.146, rely=0.827, relheight=0.025, relwidth=0.10)
...
def toplevel1(top):
    ...
    for i in mycursor:
        if len(x)==0:
            ...
            l6.place(relx=0.026, rely=0.827, relheight=0.025, relwidth=0.10)
            l7.place(relx=0.146, rely=0.827, relheight=0.025, relwidth=0.10)
            r6.set(str(0))
        else:    
            l6=tk.Label(top,text="Total Purchase :",font=("arial",15,"bold"))
...
def cb(top):
    ...
    l8.place(relx=0.718, rely=0.114, relheight=0.069, relwidth=0.149)
    r6 = DateEntry(top,width=34, background="blue",foreground="white",borderwidth=2)
    r6.place(relx=0.820, rely=0.136, relheight=0.032, relwidth=0.142)
